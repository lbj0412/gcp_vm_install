...
locals {
  source_image         = var.source_image != "" ? var.source_image : "debian-10-buster-v20210916"
  source_image_family  = var.source_image_family != "" ? var.source_image_family : "debian-10"
